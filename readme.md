Adaptar conteúdo ao template README da FIAP - Manus
pasted_content.txt
Texto · 18.96 KB
Cara 

Em anexo esta o conteúdo para o readme.md do projeto 

 

O link aqui, é o padrão templatae da FIAP que deve ser usado 

Daí por favor me ajude aí 

https://github.com/agodoi/templateFiapVfinal

Lite
Pronto. Criei o README localmente seguindo o padrão do template FIAP, com:
identificação da equipe e tutora;
descrição e objetivos;
arquitetura do sistema;
regras de irrigação;
integração Python e meteorológica;
análise em R e Quarto;
estrutura de pastas;
...
O arquivo ainda não foi commitado nem enviado ao GitHub, conforme solicitado.
Baixar o README.md final
FIAP - Faculdade de Informática e Administração Paulista
<p align="center"> <a href="https://www.fiap.com.br/"> <img src="assets/logo-fiap.png" alt="FIAP - Faculdade de Informática e Administração Paulista" width="40%"> </a> </p>
...
Simular níveis de Nitrogênio, Fósforo e Potáss
Tarefa concluída
15:35
...
Faixa de pH
Pontuação
Abaixo de 4 ou acima de 8
+3
De 4 a 5,49 ou de 7,01 a 8
+2
De 5,5 a 7
+0
Nutrientes
...
Nenhum nutriente ativo: se N, P e K estiverem inativos, o sistema não irriga, mesmo que a pontuação ambiental seja elevada.
Pontuação insuficiente: se houver algum nutriente ativo, mas a pontuação for menor que 3, o sistema não irriga.
Chuva relevante: se houver previsão de chuva relevante, o sistema não irriga, mesmo com pontuação suficiente.
Irrigação autorizada: o sistema irriga somente quando existe nutriente ativo, a pontuação é maior ou igual a 3 e não há chuva relevante prevista.
...
12h ≥ 10 mm
Chuva leve
Chuva maior que 0 mm abaixo dos limites anteriores
Sem chuva relevante
...
build do projeto PlatformIO;
inicialização do logger;
inicialização do serviço meteorológico;
inicialização da simulação Wokwi.
🧪 Testes realizados
...
Bomba inativa e decisão NÃO IRRIGAR.
2
Nutriente já atendido
Nutriente deixa de contribuir para a necessidade; pontuação igual a 0 e bomba inativa.
3
Necessidade insuficiente
Com Fósforo ativo e condições ambientais adequadas, pontuação igual a 1; bomba inativa.
4
Necessidade multicritério
Umidade aproximada de 45,8%, pH de 3,42 e Fósforo ativo produziram 6 pontos e acionaram a bomba. Ao final, pontuação igual a 2 e bomba inativa.
5
N, P e K ativos
Os nutrientes evoluíram até os níveis de atendimento; com pontuação igual a 2, a bomba permaneceu inativa.
6
Chuva relevante
Mesmo com pontuação suficiente, a previsão de chuva bloqueou a irrigação.
7
Sem chuva relevante
Com N e P ativos e precipitação igual a 0 mm, a bomba foi acionada até a pontuação deixar de justificar a irrigação.
...
Decisões IRRIGAR
2
Decisões NÃO IRRIGAR
17
Registros sem irrigação
89,47%
...
O modelo de README utilizado como referência é disponibilizado pela FIAP sob a licença Creative Commons Attribution 4.0 International: modelo de README da FIAP.
🔗 Referências
FIAP - Faculdade de Informática e Administração Paulista
Template FIAP utilizado como referência
Wokwi - Simulador de eletrônica online
PlatformIO - Ecossistema de desenvolvimento para sistemas embarcados
